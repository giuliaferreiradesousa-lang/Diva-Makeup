/* =========================================================
   ...
   Consome diretamente o componente estruturado CheckoutComponent.
   ========================================================= */
...
/* --------------------------------------------------
   PARTE 3: RENDERS E VÍNCULOS DE INTERFACE
   -------------------------------------------------- */
function renderizarCheckout() {
  ...
  // UNIFICAÇÃO: Removidas as funções duplicadas. Agora consome o componente puro.
  conteudo.innerHTML = CheckoutComponent({
    cartItems: itens,
